...
namespace csharp_test_client
{
    public partial class mainForm
    {
        ...
        void PacketProcess_ErrorNotify(byte[] bodyData)
        {
            ...
            DevLog.Write($"에러 통보 받음:  {notifyPkt.ErrorCode}");
        }
        ...
        void PacketProcess_RoomChatNotify(byte[] bodyData)
        {
            ...
            AddRoomChatMessageList(responsePkt.UserUniqueId, responsePkt.Msg);
        }

        void AddRoomChatMessageList(UInt64 userUniqueId, string msgssage)
        {
