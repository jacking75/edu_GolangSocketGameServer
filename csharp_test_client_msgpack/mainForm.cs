...
namespace csharp_test_client
{
    public partial class mainForm : Form
    {
        ...
        void AddRoomUserList(UInt64 userUniqueId, string userID)
        {
        ...
        private void btn_RoomEnter_Click(object sender, EventArgs e)
        {
            ...
            var bodyData = requestPkt.ToBytes();
            PostSendPacket(PACKET_ID.PACKET_ID_ROOM_ENTER_REQ, bodyData);
        ...
        private void btnRoomChat_Click(object sender, EventArgs e)
        {
            ...
            requestPkt.Msg = textBoxRoomSendMsg.Text;
