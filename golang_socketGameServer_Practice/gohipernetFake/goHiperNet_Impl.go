...
func _InitNetworkSendFunction() {
	...
	NetLibIIsAliveSession = isAliveSession
...
func isAliveSession(sessionIndex int32, sessionUniqueID uint64) bool {
	_, result := _tcpSessionManager._findSession(sessionIndex, sessionUniqueID)
	return result
}
