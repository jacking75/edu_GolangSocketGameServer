...
func (room *baseRoom) _packetProcess_EnterUser(inValidUser *roomUser, packet protocol.Packet) int16 {
	...
	//TODO 방의 상태가 NONE이 아니면 들어올 수 없다. (o)
	if room.isStateNone() == false {
		_sendRoomEnterResult(sessionIndex, sessionUniqueId, 0, protocol.ERROR_CODE_ENTER_ROOM_GAME_IN_PROGRESS)
		return protocol.ERROR_CODE_ENTER_ROOM_GAME_IN_PROGRESS
	}
	...
	_sendRoomEnterResult(sessionIndex, sessionUniqueId, room._masterUserSessionUniqueId, protocol.ERROR_CODE_NONE)
	return protocol.ERROR_CODE_NONE
}

func _sendRoomEnterResult(sessionIndex int32, sessionUniqueId uint64, MasterUserUniqueId uint64, result int16) {
